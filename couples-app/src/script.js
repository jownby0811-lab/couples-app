...
let gameData = JSON.parse(localStorage.getItem("gameData")) || {
  tease: {
    truths: [
      {
        text:
          "How turned on are you by the idea of using toys to simulate a threesome on her?",
        Gender: "neutral"
      },
      {
        text: "How do you feel about light bondage or tying her up?",
        Gender: "male"
      },
      {
        text: "How do you feel about light bondage or tying him up?",
        Gender: "female"
      },
      {
        text: "Would you rather tie her up or be the one restrained?",
        Gender: "male"
      },
      {
        text: "Would you rather tie him up or be the one restrained?",
        Gender: "female"
      },
      {
        text: "What lingerie on her turns you on the most?",
        Gender: "male"
      },
      {
        text: "How do you feel about light hair pulling?",
        Gender: "neutral"
      },
      {
        text: "How turned on are you by watching in a mirror?",
        Gender: "neutral"
      },
      {
        text: "On a scale of 1-10, how much do you enjoy praising her?",
        Gender: "male"
      },
      {
        text: "On a scale of 1-10, how much do you enjoy being praised by him?",
        Gender: "female"
      },
      {
        text: "What's a mild roleplay scenario that sounds fun to you?",
        Gender: "neutral"
      },
      {
        text: "How do you feel about light spit play?",
        Gender: "neutral"
      },
      {
        text: "How curious are you about gentle ass play on her?",
        Gender: "male"
      },
      {
        text: "What's a fantasy you've had about us that you haven't shared?",
        Gender: "neutral"
      },
      {
        text: "How do you feel about light bondage or being tied up?",
        Gender: "neutral"
      },
      {
        text: "Would you rather tie me up or be the one restrained?",
        Gender: "neutral"
      },
      {
        text: "How turned on are you by wearing sexy lingerie?",
        Gender: "female"
      },
      {
        text: "What's one compliment or praise that turns you on?",
        Gender: "neutral"
      },
      {
        text: "How do you feel about light hair pulling?",
      ...
      {
        text: "Would you like to try simple roleplay (strangers, etc.)?",
        Gender: "neutral"
      },
      {
        text: "How do you feel when I call you \"good girl\"?",
        Gender: "female"
      },
      {
        text: "What's a fantasy you've had about us that you haven't shared?",
      ...
      {
        text: "What's the hottest outfit or lingerie you've imagined me in?",
        Gender: "neutral"
      },
      {
        text: "How do you feel about getting a little messy with spit?",
        Gender: "neutral"
      },
      {
        text: "Does the idea of using toys to feel 'full' turn you on?",
        Gender: "female"
      },
      {
        text:
          "How turned on are you by the idea of multiple holes being played with?",
        Gender: "neutral"
      },
      {
        text: "What's one small touch or tease that always gets you going?",
        Gender: "neutral"
      },
      {
        text: "Would you like to try a butt plug while we're just teasing?",
        Gender: "female"
      },
      {
        text: "How hot does it sound to combine me + toys?",
        Gender: "female"
      },
      {
        text:
          "Where's a place outside the bedroom you've wanted to fool around?",
        Gender: "neutral"
      },
      {
        text: "Ice, massage oil, or blindfold — which sounds fun right now?",
        Gender: "neutral"
      },
      {
        text: "How do you feel when I tease you for a long time?",
        Gender: "neutral"
      },
      {
        text: "What's one sexy nickname you like or want to use?",
        Gender: "neutral"
      },
      {
        text: "Do you like when I lightly spank you?",
        Gender: "female"
      },
      {
        text: "What's something sweet + dirty you'd like me to say?",
        Gender: "neutral"
      },
      {
        text: "How turned on do you get from eye contact and slow kissing?",
        Gender: "neutral"
      },
      {
        text:
          "What's one thing you've seen about eating pussy or blowjobs you're curious about?",
        Gender: "neutral"
      },
      {
        text:
          "On a scale of 1-10, how confident do you feel going down on each other?",
        Gender: "neutral"
      },
      {
        text:
          "What's one thing you've seen or heard about eating pussy that you're curious to try?",
        Gender: "male"
      },
      {
        text:
          "On a scale of 1-10, how confident do you feel going down on her?",
        Gender: "male"
      },
      {
        text: "What's something you already enjoy about licking her pussy?",
        Gender: "male"
      },
      {
        text: "How do you feel when she moans or grabs your head?",
        Gender: "male"
      },
      {
        text:
          "What's one compliment about her pussy that you could say out loud?",
        Gender: "male"
      },
      {
        text: "Do you like when she watches you while you eat her out?",
        Gender: "male"
      },
      {
        text: "What's a simple way you like to start eating her out?",
        Gender: "male"
      },
      {
        text: "How turned on do you get knowing you're making her feel good?",
        Gender: "male"
      },
      {
        text:
          "What's one gentle thing she could say to help you feel more confident?",
        Gender: "male"
      },
      {
        text: "Do you prefer slow and teasing or eager and hungry?",
        Gender: "neutral"
      },
      {
        text:
          "What's one thing you've seen or heard about blowjobs that you're curious to try?",
        Gender: "female"
      },
      {
        text:
          "On a scale of 1-10, how confident do you feel giving head right now?",
        Gender: "female"
      },
      {
        text: "What's something you already enjoy about sucking me?",
        Gender: "female"
      },
      {
        text: "How do you feel when I moan or give you feedback?",
        Gender: "female"
      },
      {
        text: "What's one compliment you can give about my dick right now?",
        Gender: "female"
      },
      {
        text: "What's a simple way you'd like to start going down next time?",
        Gender: "female"
      },
      {
        text: "How turned on do you get knowing you're making me feel good?",
        Gender: "female"
      },
      {
        text:
          "What's one gentle thing I could say to help you feel more confident?",
        Gender: "female"
      },
      {
        text:
          "What's one compliment about your body you love giving or hearing?",
        Gender: "neutral"
      },
      {
        text: "How do you feel when I use a sexy voice with you?",
        Gender: "neutral"
      },
      {
        text: "What's a simple word or nickname that turns you on?",
        Gender: "neutral"
      },
      
      {
        text: "Do you like when I tell you how good you look?",
        Gender: "neutral"
      },
      {
        text: "What's something small I do that makes you blush?",
        Gender: "neutral"
      },
      {
        text: "How turned on does my teasing voice make you?",
        Gender: "neutral"
      },
      {
        text: "What's a mild fantasy you've had about us this week?",
        Gender: "neutral"
      },
      {
        text: "Do you prefer sweet compliments or a little naughty ones?",
        Gender: "neutral"
      },
      {
        text: "What's one touch from me that always feels nice?",
        Gender: "neutral"
      },
      {
        text: "How does it feel when I whisper in your ear?",
        Gender: "neutral"
      },
      {
        text: "What's the hottest thing I've ever worn that turned you on?",
        Gender: "neutral"
      },
      {
        text: "Describe your favorite way I tease you.",
        Gender: "neutral"
      },
      {
        text: "What's a sexual fantasy about me you haven't shared?",
        Gender: "neutral"
      },
      {
        text: "When was the last time you touched yourself thinking about me?",
        Gender: "neutral"
      },
      {
        text: "What's the sexiest thing I've ever said to you?",
        Gender: "neutral"
      },
      {
        text: "If you could touch me in only one place right now, where?",
        Gender: "neutral"
      },
      {
        text: "What's your favorite intimate memory of us?",
        Gender: "neutral"
      },
      {
        text: "What small thing I do drives you crazy with lust?",
        Gender: "neutral"
      },
      {
        text: "Be honest — how often do you get turned on thinking about me?",
        Gender: "neutral"
      },
      {
        text: "What's one compliment about my body you've held back?",
        Gender: "neutral"
      }
    ],
    dares: [
  ...
  foreplay: {
    truths: [
      {
        text: "How confident do you feel fingering her ass?",
        Gender: "male"
      },
      {
        text: "How much do you enjoy edging her during foreplay?",
        Gender: "male"
      },
      {
        text: "Would you like to pull her hair while going down on her?",
        Gender: "male"
      },
      {
        text: "How hot is it watching her suck a toy while you touch her?",
        Gender: "male"
      },
      {
        text: "Do you prefer praising her or lightly degrading her?",
        Gender: "male"
      },
      {
        text: "How do you feel about lightly choking her?",
        Gender: "male"
      },
      {
        text: "How much do you enjoy spanking her?",
        Gender: "male"
      },
      {
        text: "What turns you on about restraining her during oral?",
        Gender: "male"
      },
      {
        text: "How do you feel controlling when she can cum?",
        Gender: "male"
      },
      {
        text: "How turned on are you by her wearing a butt plug?",
        Gender: "male"
      },
      {
        text: "How does light spanking turn you on?",
        Gender: "female"
      },
      {
        text: "Do you prefer being praised or lightly degraded?",
        Gender: "female"
      },
      {
        text: "How do you feel when he edges you during foreplay?",
        Gender: "female"
      },
      {
        text: "Would you like him to pull your hair while going down on you?",
        Gender: "female"
      },
      {
        text: "How confident do you feel being restrained during oral?",
        Gender: "female"
      },
      {
        text: "What's one roleplay line you'd be okay saying?",
        Gender: "female"
      },
      {
        text: "How hot is it watching yourself get touched in a mirror?",
        Gender: "neutral"
      },
      {
        text: "Do you like when they tell you exactly how good you taste/look?",
        Gender: "neutral"
      },
      {
        text: "How do you feel about being told not to cum yet?",
        Gender: "female"
      },
      {
        text: "What's a fantasy name you'd like to call them/be called?",
        Gender: "neutral"
      },
      {
        text: "What's your favorite way for him to use his fingers?",
        Gender: "female"
      },
      {
        text: "How do you feel about ass play or fingering?",
        Gender: "female"
      },
      {
        text: "Does wearing a butt plug during foreplay sound hot?",
        Gender: "neutral"
      },
      {
        text: "What's better — slow sensual touching or getting messy?",
        Gender: "neutral"
      },
      {
        text:
          "How do you feel when he combines oral with a finger in your ass?",
        Gender: "female"
      },
      {
        text: "Would you like to suck him or a toy while he fingers you?",
        Gender: "female"
      },
      {
        text: "How turned on are you by feeling full in multiple places?",
        Gender: "female"
      },
      {
        text: "Do you prefer gentle or a little more intense ass stimulation?",
        Gender: "female"
      },
      {
        text: "What's one new foreplay combo with toys you'd like to try?",
        Gender: "neutral"
      },
      {
        text:
          "How does it feel when he focuses on your clit and ass at the same time?",
        Gender: "female"
      },
      {
        text: "What's your favorite way for him to use his fingers?",
      ...
      {
        text: "Do you prefer nipples played with gently or a little rough?",
        Gender: "female"
      },
      {
        text: "How do you feel when they lightly pull your hair?",
        Gender: "neutral"
      },
      {
        text:
          "Would you rather be in control or have them take control right now?",
        Gender: "neutral"
      },
      {
        text: "What's better — slow sensual touching or eager and rough?",
        Gender: "neutral"
      },
      {
        text: "How do you feel when they tell you exactly what feels good?",
        Gender: "neutral"
      },
      {
        text: "What's one new foreplay thing you want to try tonight?",
        Gender: "neutral"
      },
      {
        text: "Do you like temperature play (hot or cold sensations)?",
        Gender: "neutral"
      },
      {
        text: "What's one part of oral you're feeling more confident about?",
        Gender: "neutral"
      },
      {
        text: "How does it feel when they focus completely on you?",
        Gender: "neutral"
      },
      {
        text: "What's one part of eating pussy that you already feel good at?",
        Gender: "male"
      },
      {
        text: "Would you rather focus on her clit, lips, or inside her?",
        Gender: "male"
      },
      {
        text: "How does it feel when she guides your head?",
        Gender: "male"
      },
      {
        text: "What's one new technique you want to try on her tonight?",
        Gender: "male"
      },
      {
        text: "Do you like using your fingers while licking her?",
        Gender: "male"
      },
      {
        text: "How do you feel when she tells you exactly what feels best?",
        Gender: "male"
      },
      {
        text: "What's better — gentle licking or getting really sloppy?",
        Gender: "neutral"
      },
      {
        text: "Do you enjoy when she gets loud while you eat her out?",
        Gender: "male"
      },
      {
        text:
          "What's one spot on her pussy you like paying extra attention to?",
        Gender: "male"
      },
      {
        text: "How confident do you feel trying new things with your tongue?",
        Gender: "male"
      },
      {
        text: "What's one part of giving head that you already feel good at?",
        Gender: "female"
      },
      {
        text: "Would you rather focus on the head, shaft, or balls right now?",
        Gender: "female"
      },
      {
        text: "How does it feel when he gently guides your head?",
        Gender: "female"
      },
      {
        text: "What's one new technique you want to try tonight?",
        Gender: "female"
      },
      {
        text: "Do you like using your hand together with your mouth?",
        Gender: "female"
      },
      {
        text: "Do you enjoy when he gets vocal while you suck him?",
        Gender: "female"
      },
      {
        text:
          "What's one spot on his cock that you like paying extra attention to?",
        Gender: "female"
      },
      {
        text: "How confident do you feel trying new things with your mouth?",
        Gender: "female"
      },
      {
        text: "How do you feel when he tells you exactly what he's doing?",
        Gender: "female"
      },
      {
        text: "Do you like hearing him call you 'good girl'?",
        Gender: "female"
      },
      {
        text: "Would you like him to guide your hands during foreplay?",
        Gender: "female"
      },
      {
        text: "What's your favorite way for him to use his fingers?",
      ...
      {
        text: "What's the sluttiest thought you've had about him this week?",
        Gender: "female"
      },
      {
        text: "What's a foreplay move that always makes you lose control?",
        Gender: "female"
      },
      {
        text:
          "If he only had his hands for 10 minutes, what would you beg for?",
        Gender: "female"
      }
    ],
    dares: [
      {
        text: "Finger her ass gently while licking her clit.",
        Gender: "male",
        tags: ["oral", "ass-play"]
      },
      {
        text: "69 while lightly pulling her hair.",
        Gender: "male",
        tags: ["oral"]
      },
      {
        text: "Let her suck a dildo while you finger her.",
        Gender: "male",
        tags: ["oral", "toys", "manual"]
      },
      {
        text: "Spank her 8-10 times while she counts.",
        Gender: "male",
        tags: ["spanking"]
      },
      {
        text: "Tie her hands and go down on her.",
        Gender: "male",
        tags: ["bondage", "oral"]
      },
      {
        text: "Edge her with your mouth and fingers for 90 seconds.",
        Gender: "male",
        tags: ["oral", "edging", "manual"]
      },
      {
        text: "Lightly hold her throat while fingering her.",
        Gender: "male",
        tags: ["manual"]
      },
      {
        text: "Put a butt plug in her then eat her out.",
        Gender: "male",
        tags: ["toys", "ass-play", "oral"]
      },
      {
        text: "Make her watch herself in the mirror while you touch her.",
        Gender: "male",
        tags: ["manual", "mirror"]
      },
      {
        text: "Praise or lightly degrade her while teasing.",
        Gender: "male",
        tags: ["dirty-talk", "praise", "teasing"]
      },
      {
        text: "Edge each other with hands and mouth for 90 seconds.",
        Gender: "neutral",
        tags: ["oral", "manual", "edging"]
      },
      {
        text: "Give him a blowjob while watching yourself in a mirror.",
        Gender: "female",
        tags: ["oral", "mirror"]
      },
      {
        text: "Roleplay as boss/secretary during foreplay.",
        Gender: "neutral",
        tags: ["roleplay"]
      },
      {
        text: "Praise each other out loud while touching.",
        Gender: "neutral",
        tags: ["praise", "manual"]
      },
      {
        text: "Give him a blowjob while fucking yourself with a dildo.",
        Gender: "female",
        tags: ["oral", "toys"]
      },
      {
        text: "Suck a dildo while he fingers your pussy and ass.",
        Gender: "female",
        tags: ["oral", "toys", "manual", "ass-play"]
      },
      {
        text: "Spit on his cock and give a sloppy handjob + blowjob.",
        Gender: "female",
        tags: ["spit-play", "manual", "oral"]
      },
      {
        text: "Wear a butt plug while giving him head.",
        Gender: "female",
        tags: ["toys", "ass-play", "oral"]
      },
      {
        text: "Finger her ass slowly while she strokes you.",
        Gender: "male",
        tags: ["ass-play", "manual"]
      },
      {
        text: "Finger her / stroke him while keeping eye contact and talking.",
        Gender: "neutral",
        tags: ["manual", "dirty-talk"]
      },
      {
        text: "69 for 60–90 seconds, nice and slow.",
        Gender: "neutral",
        tags: ["oral"]
      },
      {
        text: "Let him spank you 8–10 times while you count them.",
        Gender: "female",
        tags: ["spanking"]
      },
      {
        text: "Ride his fingers while describing how it feels.",
        Gender: "female",
        tags: ["manual", "dirty-talk"]
      },
      {
        text:
          "Use your mouth on them while they use their fingers/hand on you.",
        Gender: "neutral",
        tags: ["oral", "manual"]
      },
      {
        text: "Alternate between slow and fast oral for one minute.",
        Gender: "neutral",
        tags: ["oral", "edging"]
      },
      {
        text: "Stay still while the other teases you — no moving your hands.",
        Gender: "neutral",
        tags: ["teasing", "edging"]
      },
      {
        text: "Guide each other's hands exactly where you want them.",
        Gender: "neutral",
        tags: ["manual"]
      },
      {
        text: "Suck gently on her clit while using a finger inside her.",
        Gender: "male",
        tags: ["oral", "manual"]
      },
      {
        text: "Take her clit in your mouth and hold suction for 10 seconds.",
        Gender: "male",
        tags: ["oral"]
      },
      {
        text: "Use the tip of your tongue to flick her clit rapidly.",
        Gender: "male",
        tags: ["oral"]
      },
      {
        text: "Alternate between slow licking and fast clit circles.",
        Gender: "male",
        tags: ["oral", "edging"]
      },
      {
        text: "Lick and suck her labia while fingering her.",
        Gender: "male",
        tags: ["oral", "manual"]
      },
      {
        text: "Make eye contact with her while licking her clit.",
        Gender: "male",
        tags: ["oral"]
      },
      {
        text: "Hum or moan with your mouth on her so she feels the vibration.",
        Gender: "male",
        tags: ["oral"]
      },
      {
        text: "Mix kissing, licking, and sucking all over her pussy.",
        Gender: "male",
        tags: ["oral"]
      },
      {
        text: "Let her guide your head to where she wants your tongue.",
        Gender: "male",
        tags: ["oral"]
      },
      {
        text: "Suck just the head with good suction while stroking the shaft.",
        Gender: "female",
        tags: ["oral", "manual"]
      },
      {
        text:
          "Take him as deep as comfortable, hold for 5 seconds, then pull back slowly.",
        Gender: "female",
        tags: ["oral"]
      },
      {
        text:
          "Use your tongue to flick the underside of the head for 45 seconds.",
        Gender: "female",
        tags: ["oral"]
      },
      {
        text:
          "Alternate between slow bobbing and fast shallow sucks for 60 seconds.",
        Gender: "female",
        tags: ["oral", "edging"]
      },
      {
        text: "Lick and suck his balls gently while stroking him.",
        Gender: "female",
        tags: ["oral", "manual"]
      },
      {
        text: "Make eye contact for 15 seconds while bobbing on him.",
        Gender: "female",
        tags: ["oral"]
      },
      {
        text:
          "Try humming/moaning with him in your mouth so he feels the vibration.",
        Gender: "female",
        tags: ["oral"]
      },
      {
        text: "Mix kissing, licking, and sucking all over for one minute.",
        Gender: "female",
        tags: ["oral"]
      },
      {
        text:
          "Guide his hand to your head if you want him to lead for 30 seconds.",
        Gender: "female",
        tags: ["oral"]
      },
      {
        text: "Guide his hand where you want it and say 'Right there'.",
        Gender: "female",
        tags: ["manual", "dirty-talk"]
      },
      {
        text: "While he touches you, say 'That feels so good'.",
        Gender: "female",
        tags: ["dirty-talk"]
      },
      {
        text: "Finish this: 'I love when you touch my...'",
        Gender: "female",
        tags: ["dirty-talk"]
      },
      {
        text: "Say 'Don't stop' every time something feels really good.",
        Gender: "female",
        tags: ["dirty-talk"]
      },
      {
        text: "Finish this: 'Your fingers/tongue feel so...'",
        Gender: "female",
        tags: ["dirty-talk"]
      },
      {
        text: "Look at him and say 'I want your mouth here'.",
        Gender: "female",
        tags: ["dirty-talk"]
      },
      {
        text: "React out loud with moans or words when it feels intense.",
        Gender: "female",
        tags: ["dirty-talk"]
      },
      {
        text: "Finish this: 'I'm getting so turned on because...'",
        Gender: "neutral",
        tags: ["dirty-talk"]
      },
      {
        text: "Say 'Please keep going' while riding his fingers.",
        Gender: "female",
        tags: ["manual", "dirty-talk"]
      },
      {
        text: "Touch yourself while he watches and tell you exactly how.",
        Gender: "female",
        tags: ["manual", "dirty-talk"]
      },
      {
        text: "Give them oral for 2 minutes — no hands allowed.",
        Gender: "neutral",
        tags: ["oral"]
      },
      {
        text: "69 for 90 seconds but don't cum.",
        Gender: "neutral",
        tags: ["oral", "edging"]
      },
      {
        text:
          "Ride his fingers while looking him in the eyes and talking dirty.",
        Gender: "female",
        tags: ["manual", "dirty-talk"]
      }
    ]
  ...
  dirty: {
    truths: [
      {
        text: "How hot is it for you to fill her with toys + your cock?",
        Gender: "male"
      },
      {
        text: "How much do you enjoy pulling her hair while fucking?",
        Gender: "male"
      },
      {
        text: "How turned on are you by heavy choking during sex?",
        Gender: "neutral"
      },
      {
        text: "How do you feel about spanking her while inside her?",
        Gender: "male"
      },
      {
        text: "How much do you like controlling her orgasms?",
        Gender: "male"
      },
      {
        text: "Would you rather dominate or be dominated?",
        Gender: "neutral"
      },
      {
        text: "How hot is fucking her in front of a mirror?",
        Gender: "male"
      },
      {
        text: "How much do you enjoy using multiple holes at once?",
        Gender: "neutral"
      },
      {
        text: "What's the hottest roleplay scenario you want to do?",
        Gender: "neutral"
      },
      {
        text: "How turned on are you by making things really sloppy?",
        Gender: "neutral"
      },
      {
        text: "How hot is it when he calls you his little slut?",
        Gender: "female"
      },
      {
        text: "How turned on are you by being fully restrained?",
        Gender: "neutral"
      },
      {
        text: "Do you like being spanked while he's inside you?",
        Gender: "female"
      },
      {
        text: "How does it feel when he controls when you cum?",
        Gender: "female"
      },
      {
        text: "What's one degrading or praising phrase that turns you on?",
        Gender: "female"
      },
      {
      ...
      {
        text: "Does being filled in multiple holes turn you on?",
        Gender: "female"
      },
      {
        text: "How do you feel about combining him + toys at the same time?",
        Gender: "female"
      },
      {
        text: "Would you like a plug in your ass while he fucks your pussy?",
        Gender: "female"
      },
      {
        text:
          "How turned on are you by sucking one thing while getting fucked?",
        Gender: "female"
      },
      {
        text: "What's the hottest way to use our dildos together?",
        Gender: "female"
      },
      {
        text: "How does it feel when I pull your hair and go harder?",
        Gender: "neutral"
      },
      {
        text: "Do you like when we get messy with spit during sex?",
        Gender: "neutral"
      },
      {
        text: "How intense does it feel when multiple holes are stimulated?",
        Gender: "female"
      },
      {
        text: "Do you like being fucked/fucking deep and rough?",
        Gender: "neutral"
      },
      {
        text: "What's a kink or position you've thought about but never tried?",
        Gender: "neutral"
      },
      {
        text: "How hot is it when he talks dirty while inside you?",
        Gender: "female"
      },
      {
        text: "Where do you like him to cum most?",
        Gender: "female"
      },
      {
        text: "What's the hottest thing we've ever done together?",
        Gender: "neutral"
      },
      {
        text: "How do you feel right before and during orgasm?",
        Gender: "neutral"
      },
      {
        text:
          "What's one cunnilingus technique you want to get really good at?",
        Gender: "male"
      },
      {
        text: "How hot is it when she loses control because of your tongue?",
        Gender: "male"
      },
      {
        text:
          "Do you like talking dirty while your face is buried in her pussy?",
        Gender: "male"
      },
      {
        text: "How does it feel when she cums on your tongue or face?",
        Gender: "male"
      },
      {
        text:
          "Would you rather make her cum with your mouth, fingers, or both?",
        Gender: "male"
      },
      {
        text: "What's one way you want her to praise you after eating her out?",
        Gender: "male"
      },
      {
        text: "How turned on are you when she can't stay quiet?",
        Gender: "male"
      },
      {
        text: "What's a fantasy involving your mouth between her legs?",
        Gender: "male"
      },
      {
        text: "Do you like telling her how good she tastes in the moment?",
        Gender: "male"
      },
      {
        text: "What's one blowjob technique you want to get really good at?",
        Gender: "female"
      },
      {
        text: "How hot is it when he loses control because of your mouth?",
        Gender: "female"
      },
      {
        text: "Do you like to talk dirty while you're sucking him?",
        Gender: "female"
      },
      {
        text: "What's the sluttiest thought you've had while giving head?",
        Gender: "female"
      },
      {
        text: "How does it feel when he cums in your mouth or on you?",
        Gender: "female"
      },
      {
        text: "Would you rather finish him with your mouth, hand, or both?",
        Gender: "female"
      },
      {
        text: "What's one way you want him to praise you after a blowjob?",
        Gender: "female"
      },
      {
        text: "How turned on are you when he can't stay quiet?",
        Gender: "female"
      },
      {
        text:
          "What's a fantasy involving your mouth that you haven't told him?",
        Gender: "female"
      },
      {
        text:
          "Do you like when he tells you how good you're doing in the moment?",
        Gender: "female"
      },
      {
        text: "What's one dirty thing you've wanted to say but felt shy?",
        Gender: "female"
      },
      {
        text: "How hot does it get when he talks while inside you?",
        Gender: "female"
      },
      {
        text: "Do you like hearing exactly how good you feel?",
        Gender: "neutral"
      },
      {
        text: "What's a position where you feel most confident?",
        Gender: "neutral"
      },
      {
        text: "How do you feel when they take control and talk dirty?",
        Gender: "neutral"
      },
      {
        text: "What's something we've done that you want more of?",
        Gender: "neutral"
      },
      {
        text: "Do you like being told you're tight/wet/good?",
        Gender: "female"
      },
      {
        text: "What's one naughty thought you've had during sex?",
        Gender: "female"
      },
      {
        text: "What's a sexy thing you'd like to try next time?",
        Gender: "neutral"
      },
      {
        text: "What's the dirtiest fantasy you've had about them?",
        Gender: "neutral"
      },
      {
        text:
          "Sweet, filthy, or degrading — how do you like them to talk during sex?",
        Gender: "neutral"
      },
      {
        text: "What's a kink you've been nervous to ask for?",
        Gender: "neutral"
      },
      {
        text:
          "If we filmed ourselves fucking, what would turn you on most later?",
        Gender: "neutral"
      }
    ],
    dares: [
      {
        text: "Fuck her while she sucks a dildo.",
        Gender: "male",
        tags: ["penetration", "oral", "toys"]
      },
      {
        text: "Pull her hair while fucking her from behind.",
        Gender: "male",
        tags: ["penetration"]
      },
      {
        text: "Spank her ass while pounding her.",
        Gender: "male",
        tags: ["penetration", "spanking"]
      },
      {
        text: "Fuck her with a butt plug already in her.",
        Gender: "male",
        tags: ["penetration", "toys", "ass-play"]
      },
      {
        text: "Roughly choke her while fucking (very hard).",
        Gender: "male",
        tags: ["penetration", "bondage"]
      },
      {
        text: "Fuck her in front of a mirror while she watches.",
        Gender: "male",
        tags: ["penetration", "mirror"]
      },
      {
        text: "Use a dildo in one of her holes while you fuck another.",
        Gender: "male",
        tags: ["penetration", "toys", "ass-play"]
      },
      {
        text: "Edge her right to the edge then let her cum.",
        Gender: "male",
        tags: ["penetration", "edging"]
      },
      {
        text: "Roleplay a full dirty scenario while fucking.",
        Gender: "neutral",
        tags: ["penetration", "roleplay"]
      },
      {
        text: "Fuck in front of a mirror while describing what you see.",
        Gender: "female",
        tags: ["penetration", "mirror", "dirty-talk"]
      },
      {
        text: "Beg to cum using dirty praise or degradation.",
        Gender: "female",
        tags: ["dirty-talk", "degradation", "edging"]
      },
      {
        text:
          "Let him restrain you and use you however he wants for 2 minutes.",
        Gender: "female",
        tags: ["bondage", "penetration"]
      },
      {
        text: "Switch between slow praise and filthy talk while fucking.",
        Gender: "neutral",
        tags: ["penetration", "dirty-talk", "praise"]
      },
      {
        text: "Fuck in your favorite position with lots of spit.",
        Gender: "neutral",
        tags: ["penetration", "spit-play"]
      },
      {
        text: "Suck him while riding a dildo.",
        Gender: "female",
        tags: ["oral", "toys", "penetration"]
      },
      {
        text: "Insert butt plug then let him fuck your pussy.",
        Gender: "female",
        tags: ["toys", "ass-play", "penetration"]
      },
      {
        text: "Suck a dildo while he fucks you from behind.",
        Gender: "female",
        tags: ["penetration", "oral", "toys"]
      },
      {
        text: "Suck him + dildo in pussy + plug in ass.",
        Gender: "female",
        tags: ["oral", "toys", "penetration", "ass-play"]
      },
      {
        text: "Stroke one toy, suck him, and ride another.",
        Gender: "female",
        tags: ["oral", "toys", "penetration", "manual"]
      },
      {
        text:
          "Use a dildo in her ass while you fuck her pussy (or vice versa).",
        Gender: "male",
        tags: ["penetration", "toys", "ass-play"]
      },
      {
        text: "Switch between him and toys in different holes for 3 minutes.",
        Gender: "female",
        tags: ["penetration", "toys", "ass-play"]
      },
      {
        text: "Ride him reverse cowgirl while watching in a mirror.",
        Gender: "female",
        tags: ["penetration", "mirror"]
      },
      {
        text: "Switch positions every 30 seconds for 3 minutes.",
        Gender: "neutral",
        tags: ["penetration"]
      },
      {
        text:
          "Let her ride your face / let him fuck your mouth while they control pace.",
        Gender: "neutral",
        tags: ["oral"]
      },
      {
        text: "Focus hard on her clit with strong suction and tongue flicks.",
        Gender: "male",
        tags: ["oral"]
      },
      {
        text: "Try burying your tongue as deep as possible inside her.",
        Gender: "male",
        tags: ["oral"]
      },
      {
        text: "Edge her with your mouth — bring her close then slow down.",
        tags: ["oral", "edging"]
      },
      {
        text: "Eat her out aggressively while she's close to cumming.",
        Gender: "male",
        tags: ["oral", "edging"]
      },
      {
        text: "Suck her clit while saying 'I love eating your pussy'.",
        Gender: "male",
        tags: ["oral", "dirty-talk"]
      },
      {
        text: "Let her grind on your face while you lick her.",
        Gender: "male",
        tags: ["oral", "grinding"]
      },
      {
        text: "Mix fast tongue flicks, slow licks, and deep sucking.",
        Gender: "neutral",
        tags: ["oral"]
      },
      {
        text: "Make her cum with your mouth while keeping eye contact.",
        Gender: "male",
        tags: ["oral"]
      },
      {
        text: "Describe how good she tastes while licking her.",
        Gender: "male",
        tags: ["oral", "dirty-talk"]
      },
      {
        text: "Beg her to cum on your tongue using dirty words.",
        Gender: "male",
        tags: ["oral", "dirty-talk"]
      },
      {
        text: "Use hand + mouth in rhythm (twist your hand as you go up).",
        Gender: "female",
        tags: ["oral", "manual"]
      },
      {
        text:
          "Focus hard on the head with strong suction and tongue flicks for 60s.",
        Gender: "female",
        tags: ["oral"]
      },
      {
        text: "Try taking me deeper than usual and tell him how it felt.",
        Gender: "female",
        tags: ["oral", "dirty-talk"]
      },
      {
        text: "Edge him with your mouth — bring him close then slow way down.",
        Gender: "female",
        tags: ["oral", "edging"]
      },
      {
        text: "Suck him while saying 'I love sucking your dick'.",
        Gender: "female",
        tags: ["oral", "dirty-talk"]
      },
      {
        text: "Let him gently fuck your mouth for 30–45 seconds.",
        Gender: "female",
        tags: ["oral"]
      },
      {
        text: "Mix fast bobbing, slow licking, and deep sucks for one minute.",
        Gender: "female",
        tags: ["oral"]
      },
      {
        text: "Describe how his dick feels in your mouth while you suck him.",
        Gender: "female",
        tags: ["oral", "dirty-talk"]
      },
      {
        text:
          "Beg for his cum using one dirty sentence right before he finishes.",
        Gender: "female",
        tags: ["oral", "dirty-talk"]
      },
      {
        text: "While riding him, say 'You feel so deep'.",
        Gender: "female",
        tags: ["penetration", "dirty-talk"]
      },
      {
        text: "Finish this: 'Fuck me...' while he's inside you.",
        Gender: "female",
        tags: ["penetration", "dirty-talk"]
      },
      {
        text: "Say 'I'm your good girl' while looking at him.",
        Gender: "female",
        tags: ["dirty-talk", "praise"]
      },
      {
        text: "Describe in one sentence how their dick/pussy feels.",
        Gender: "neutral",
        tags: ["penetration", "dirty-talk"]
      },
      {
        text: "Say 'Harder' or 'Deeper' when you want more.",
        Gender: "neutral",
        tags: ["penetration", "dirty-talk"]
      },
      {
        text: "Finish this: 'I love your cock/pussy because...'",
        Gender: "neutral",
        tags: ["dirty-talk", "praise"]
      },
      {
        text: "Say 'Fill me up' or 'Cum on me' when you're close.",
        Gender: "female",
        tags: ["penetration", "dirty-talk"]
      },
      {
        text: "Beg for what you want in one short dirty sentence.",
        Gender: "female",
        tags: ["dirty-talk"]
      },
      {
        text:
          "Fuck him in your favorite position for 2 minutes while describing it.",
        Gender: "female",
        tags: ["penetration", "dirty-talk"]
      },
      {
        text: "Ride him reverse cowgirl while you watch in a mirror.",
        Gender: "female",
        tags: ["penetration", "mirror"]
      },
      {
        text: "Let him fuck your mouth while holding your head.",
        Gender: "female",
        tags: ["oral", "bondage"]
      },
      {
        text: "Let him use a toy on you until you cum, eyes on him.",
        Gender: "female",
        tags: ["toys", "manual"]
      },
      {
        text: "Switch positions every 30 seconds for 3 minutes straight.",
        Gender: "neutral",
        tags: ["penetration"]
      },
      {
        text:
          "Record 30 seconds of you riding him while describing how deep he is.",
        Gender: "female",
        tags: ["penetration", "dirty-talk"]
      }
    ]
...
function triggerBurnReveal(card) {
  ...
  // Forces browser to restart animation
